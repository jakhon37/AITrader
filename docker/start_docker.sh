...
if [ -n "$DETACH_FLAG" ]; then
    ...
    echo "   • Paper Trading:     $COMPOSE_CMD logs -f paper-trading"
    echo "   • Monitor Dashboard: $COMPOSE_CMD logs -f monitor-dashboard"
    echo "   • Feature Explorer:  $COMPOSE_CMD logs -f feature-explorer"
    echo ""
