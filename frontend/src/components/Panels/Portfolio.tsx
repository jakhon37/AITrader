...
export function Portfolio() {
  ...
  return (
    <div className="glass-panel" style={{ padding: 16, display: 'flex', flexDirection: 'column', gap: 8, overflow: 'hidden' }}>
      <h3 style={{ fontSize: 11, fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.08em', color: 'var(--text-secondary)', marginBottom: 4, display: 'flex', alignItems: 'center', gap: 8 }}>
      ...
      <div style={{ flex: 1, overflowY: 'auto', marginTop: 8 }}>
        {p.open_positions.length === 0 ? (
          ...
          <table className="terminal-table">
            <thead><tr><th>Sym</th><th>Side</th><th>Lots</th><th>Entry</th><th>PnL</th></tr></thead>
            <tbody>
